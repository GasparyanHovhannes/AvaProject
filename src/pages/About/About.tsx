...
const About = () => {
  return (
    <div className="padding_div">
      ...
      <h1 className="value_title">Our values</h1>
      <div className="value_container">
        <div className="value_box left_zero">
          <img src={leaf} alt="" className="image" />
          <h2 className="value_box_title"> Sustainability </h2>
          <h3 className="value_box_desk">We're dedicated to minimizing our environmental impact through sustainable sourcing, packaging, and production practices.</h3>
        </div>
        <div className="value_box">
          <img src={heart} alt="" className="image" />
          <h2 className="value_box_title"> Personalization </h2>
          <h3 className="value_box_desk">We believe in the power of personalized hair care, tailoring our products to meet the unique needs of each individual.</h3>
        </div>
        <div className="value_box right_zero">
          <img src={community} alt="" className="image" />
          <h2 className="value_box_title"> Community </h2>
          <h3 className="value_box_desk">We foster a community of hair enthusiasts, sharing knowledge, tips, and support to help everyone achieve their hair goals.</h3>
        </div>
      </div>
      <div className="founders">
        <h1 className="founders_title"> Meet the Founders </h1>
        ...
        <div className='founders_container'>
          ...
          <h2> Natali Portman </h2>
          <h3> Co-founder & CEO </h3>
        </div>
        <p className='founder_desk'>
